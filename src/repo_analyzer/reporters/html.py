...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  footer { margin-top: 52px; padding-top: 18px; border-top: 1px solid var(--border-2);
...
<main class="wrap">
  ...
  <section data-panel="repo" style="display:none">
    ...
    {% else %}
    <div class="empty"><div class="big">Repository posture</div>Not yet scanned. Roadmap: supply-chain posture (OpenSSF Scorecard).</div>
    {% endif %}
  </section>
